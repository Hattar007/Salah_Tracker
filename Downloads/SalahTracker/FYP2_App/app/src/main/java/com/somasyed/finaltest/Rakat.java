...
public class Rakat
{
    ...
    public Rakat(int rakatno, String namaz, int standing1time, int standing2time, int bowingtime, int prostration1time, int prostration2time, int sitting1time, int sitting2time, int rakahtime) {
