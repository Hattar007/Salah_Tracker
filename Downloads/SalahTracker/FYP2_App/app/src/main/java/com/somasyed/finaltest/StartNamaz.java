      ...
      pbar1 = findViewById(R.id.p_Bar_rakat1);
        ...
        buttonstat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("EXTRA_MESSAGE", SendData);
                intent.putExtra("EXTRA_MESSAGE1", Sendoption);
                intent.putExtra("EXTRA_MESSAGE2", Sendrakatno);
...
*/
    ...
    private void sendMsg(final JSONObject obj) {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Socket s = new Socket("192.168.43.251",5007);
...
//    @Override
    ...
    public void addData(final DatabaseReference myRef, final String date)
    {
        myRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    public void Checkposition(String Label)
    {
      ...
      //  final DatabaseReference myRef = database.getReference("UserData");
        ...
        final DatabaseReference mylogRef=database.getReference("Logs");
        addData(mylogRef,formattedDate);
...
//
        ...
        if(option.equals("Fajr"))
        {
            ...
            rakat1.namaz=option;
            rakat2.namaz=option;
            if(Label.equals("Long Standing") && counter==0)
            {
                temp.setText(Label);
...
//            a=a+10;
  ...
  //Data of Rakat 1 sent
                        //sitting 2 not added in this rakah
                        rakat1.rakahtime=rakat1.standing1time+rakat1.standing2time+rakat1.bowingtime+rakat1.prostration2time+rakat1.prostration1time+rakat1.sitting1time;
                        Fajr.add(rakat1);
                        addData(myRef,rakat1,rakat1.rakatno,rakat1.namaz);
                    temp.setText("Rakah 1 Complete");
                    //Log.d(TAG, "Checkposition rakat 1 and it complete: "+rakat1.prostration2time);
...
//            counter++;
            ...
            else if(Label.equals("Short Standing") && counter==2)
            {       temp.setText(Label);
...
//            a=a+10;
            ...
            if (Label.equals("Sitting") && counter==7 && rakat==2){
                ...
                int difference=twoDatesBetweenTime(activitytimeP2);
                    temp.setText("Namaz Complete");
                    prostrationtime=difference;
                    rakat2.prostration2time=prostrationtime;
                    rakat2.rakatno=rakat;
                rakat2.rakahtime=rakat2.standing1time+rakat2.standing2time+rakat2.bowingtime+rakat2.prostration2time+rakat2.prostration1time+rakat2.sitting1time+rakat2.sitting2time;

                Fajr.add(rakat2);
                addData(myRef,rakat2,rakat2.rakatno,rakat2.namaz);
                Log.d(TAG, "Checkposition: and rakat is 2 "+rakat2.prostration2time);
...
//            a=a+10;
                ...
                else if(rakat==3)
                {
                    ...
                    standingcount++;
                    int difference=twoDatesBetweenTime(activitytimeS2);


                    prostrationtime=difference;
                    rakat2.prostration2time=prostrationtime;
                    //Data of Rakat 2 sent
                    //sitting 2 not added in this rakah
                    rakat2.rakahtime=rakat2.standing1time+rakat2.standing2time+rakat2.bowingtime+rakat2.prostration2time+rakat2.prostration1time+rakat2.sitting2time;
                    Fajr.add(rakat2);
                    addData(myRef,rakat2,rakat2.rakatno,rakat2.namaz);
                    temp.setText("Rakah 2 Complete");
            ...
            {temp.setText(Label);
                ...
                {
                    standingtime=difference;
                    rakat3.standing1time=standingtime;
                }
                else
                {
                    standingtime=difference;
...
//            counter++;
            ...
            {   temp.setText(Label);
                ...
                {
                    standingtime=difference;
                    rakat3.standing2time=standingtime;
                }
                else
                {
                    standingtime=difference;
                    rakat2.standing2time=standingtime;
                }
            ...
            {   temp.setText(Label);
                ...
                {
                    prostrationtime=difference;
                    rakat3.prostration1time=prostrationtime;                }
                else
                {
                    prostrationtime=difference;
                    rakat2.prostration1time=prostrationtime;
...
//            a=a+10;
            ...
            if (Label.equals("Sitting") && counter==7 ){
                ...
                {
                    prostrationtime=difference;
                    rakat3.prostration2time=prostrationtime;
                }
                //
                ...
                if(rakat==3) {
                  ...
                  prostrationtime = difference;
                  rakat3.prostration2time = prostrationtime;
                  rakat3.rakatno = rakat;
                  rakat3.rakahtime = rakat3.standing1time + rakat3.standing2time + rakat3.bowingtime + rakat3.prostration2time + rakat3.prostration1time + rakat3.sitting1time + rakat3.sitting2time;

                  Fajr.add(rakat3);
                  addData(myRef, rakat3, rakat3.rakatno, rakat3.namaz);
                  Log.d(TAG, "Checkposition: and rakat is 3 " + rakat2.prostration2time);
